...
$payload = PpaCadUpdateRmaPayloadBuilder::build($baseRows, $rmaRows, $indicator, []);
...
$assertSame(
    ['CRAS MARIANA', 'CRAS PARQUE SANTA RITA', 'CRAS SOMENTE RMA', 'CRAS ZERO'],
...
$filtered = PpaCadUpdateRmaPayloadBuilder::build(
    $baseRows,
    $rmaRows,
    $indicator,
...
$defaultTarget = PpaCadUpdateRmaPayloadBuilder::build(
...
$empty = PpaCadUpdateRmaPayloadBuilder::build([], [], $indicator, []);
